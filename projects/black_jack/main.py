...
def deal_card():
    if computer_cards == 0:
        computer_first_card = cards[random.randint(0, 12)]
        computer_second_random_card = cards[random.randint(0,12)]
        computer_cards.append(computer_first_card)
        computer_cards.append(computer_second_random_card)
    elif user_cards == 0:
...
def calculate_blackjack(card_one, card_two):
    if card_one == 11 and card_two == 10:
        return blackjack
    else:
